-- =============================================================
-- Projet : mapleperroquets.com — PRODUCTION
-- Fichier : 06-seed-especes.sql
-- Objet   : Catalogue d'espèces curaté (~12) pour la vitrine.
--           Espèces seulement — oiseaux ajoutés via l'admin.
-- IMPORT  : phpMyAdmin → sélectionner d'abord la base
--           u783045005_parrots, PUIS importer ce fichier.
--           (Pas de CREATE DATABASE / USE — base déjà sélectionnée.)
